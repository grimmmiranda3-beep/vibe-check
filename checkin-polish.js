// Vibe Check — live check-in UI polish + post-check-in experience + feed entry.
(function(){
  'use strict';
  const VIBES=['😍','😊','🔥','😌','🥳'];
  ...
  function addFeedLink(){
    ...
    if(!host)return;
    const link=document.createElement('a');link.className='vibe-feed-link';link.href='feed.html';link.innerHTML='⚡ See the live Vibe Feed';
